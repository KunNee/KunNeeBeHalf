...
class Index
{
	...
	public function install()
	{
		...
		$_var_6[] = "INSERT INTO `cloud_weblist` (`web_id`, `user_qq`, `mail`, `webname`, `title`,`domain`,`start_time`,`end_time`,`prefix`,`web_key`) VALUES ('1', '2733277048', '2733277048@qq.com', 'KunNee', '你的私人助手', '" . $_SERVER["HTTP_HOST"] . "','" . date("Y-m-d") . "','2020-01-01','cloud_','" . getRandStr() . "')";
		$_var_7 = 0;
		$_var_8 = 0;
		$_var_9 = null;
		try {
